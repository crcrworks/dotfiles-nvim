return {
  {
    ...
    opts = {
      dir = "/Users/crcr/Library/Mobile Documents/iCloud~md~obsidian/Documents/crcr-main/", -- specify the vault location. no need to call 'vim.fn.expand' here
      use_advanced_uri = true,
      finder = "telescope.nvim",

      templates = {
        folder = "/Users/crcr/Library/Mobile Documents/iCloud~md~obsidian/Documents/crcr-main/_Configs/Templates",
        date_format = "%Y-%m-%d-%a",
        time_format = "%H:%M",
      },
